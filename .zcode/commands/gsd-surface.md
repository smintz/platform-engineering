...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.zcode/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.zcode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.zcode/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.zcode/skills`).
...
`/Users/smintz/git/platform-engineering/.zcode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/smintz/git/platform-engineering/.zcode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.zcode/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.zcode/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.zcode/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.zcode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.zcode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
