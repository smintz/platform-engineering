...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.zcode
                  → checks /Users/smintz/git/platform-engineering/.zcode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.zcode/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.zcode/gsd-core/hooks/
