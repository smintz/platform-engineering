...
```
Agent(
  prompt="Read /Users/smintz/git/platform-engineering/.zcode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/git/platform-engineering/.zcode/gsd-core/templates/VALIDATION.md`
