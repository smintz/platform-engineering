...
**Verification depth scales with `asvs_level`** (see @/Users/smintz/git/platform-engineering/.hermes/gsd-core/references/security-asvs-levels.md for full definitions):
