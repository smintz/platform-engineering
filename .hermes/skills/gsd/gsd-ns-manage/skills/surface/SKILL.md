...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.hermes/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.hermes/skills/gsd-*/`.
...
(`/Users/smintz/git/platform-engineering/.hermes`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.hermes/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/smintz/git/platform-engineering/.hermes` as `configDir`. The skill dirs themselves live at
`/Users/smintz/git/platform-engineering/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Hermes Agent — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/smintz/git/platform-engineering/.hermes}"
SCOPE="global"
...
(i.e. `/Users/smintz/git/platform-engineering/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.hermes/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.hermes/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.hermes/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.hermes/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.hermes/gsd-core/bin/lib/clusters.cjs`
</execution_context>
