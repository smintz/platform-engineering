...
- Usage: Reference from command with `@/Users/smintz/git/platform-engineering/.hermes/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/smintz/git/platform-engineering/.hermes/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/smintz/git/platform-engineering/.hermes/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
