...
Key references:
- @/Users/smintz/git/platform-engineering/.hermes/gsd-core/references/ui-brand.md (display patterns)
- @/Users/smintz/git/platform-engineering/.hermes/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/smintz/git/platform-engineering/.hermes/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/smintz/git/platform-engineering/.hermes/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/smintz/git/platform-engineering/.hermes/gsd-core/USER-PROFILE.md" "/Users/smintz/git/platform-engineering/.hermes/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/smintz/git/platform-engineering/.hermes/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/smintz/git/platform-engineering/.hermes/gsd-core/references/user-profiling.md`
...
Reference: @/Users/smintz/git/platform-engineering/.hermes/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/smintz/git/platform-engineering/.hermes/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global HERMES.md" -- "Add profile to /Users/smintz/git/platform-engineering/.hermes/HERMES.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/smintz/git/platform-engineering/.hermes/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/smintz/git/platform-engineering/.hermes/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/smintz/git/platform-engineering/.hermes/HERMES.md"
...
```bash
BACKUP_PATH="/Users/smintz/git/platform-engineering/.hermes/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/smintz/git/platform-engineering/.hermes/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/smintz/git/platform-engineering/.hermes/skills/gsd-dev-preferences/SKILL.md
  ✓ HERMES.md section       <resolved claude_md_path, default ./.hermes/HERMES.md>
  ✓ Global HERMES.md        /Users/smintz/git/platform-engineering/.hermes/HERMES.md
```
