...
```
delegate_task(
  prompt="Read /Users/smintz/git/platform-engineering/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/git/platform-engineering/.hermes/gsd-core/templates/SECURITY.md`
