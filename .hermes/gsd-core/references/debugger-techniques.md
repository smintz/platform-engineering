...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.hermes
                  → checks /Users/smintz/git/platform-engineering/.hermes/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.hermes/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.hermes/gsd-core/hooks/
