...
@/Users/smintz/git/platform-engineering/.augment/gsd-core/references/git-integration.md
</required_reading>
...
exactly as specified in the canonical `/Users/smintz/git/platform-engineering/.augment/gsd-core/references/tdd.md` reference — the
...
See /Users/smintz/git/platform-engineering/.augment/gsd-core/references/checkpoints.md for details.
</step>
...
If `NODE_REPAIR` is `true`: invoke `@./.augment/gsd-core/workflows/node-repair.md` with:
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `/Users/smintz/git/platform-engineering/.augment/gsd-core/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/Users/smintz/git/platform-engineering/.augment/gsd-core/templates/summary.md`.
