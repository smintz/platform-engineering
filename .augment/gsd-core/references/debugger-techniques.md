...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.augment
                  → checks /Users/smintz/git/platform-engineering/.augment/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.augment/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.augment/gsd-core/hooks/
