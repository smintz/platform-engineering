...
`@/Users/smintz/git/platform-engineering/.augment/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/Users/smintz/git/platform-engineering/.augment/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
