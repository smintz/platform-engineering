...
<execution_context>
@/Users/smintz/git/platform-engineering/.augment/gsd-core/workflows/code-review.md
</execution_context>
...
Context files (.augment/rules/, SUMMARY.md, phase state) are resolved inside the workflow via `gsd-tools query init.phase-op` and delegated to agent via `<required_reading>` blocks.
</context>
