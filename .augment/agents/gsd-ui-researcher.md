...
@/Users/smintz/git/platform-engineering/.augment/gsd-core/references/ui-consideration-probe.md
...
Use template from `/Users/smintz/git/platform-engineering/.augment/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/smintz/git/platform-engineering/.augment/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / .augment/rules/ rule / spec constraint} | {one line} |
