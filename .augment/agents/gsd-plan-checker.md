...
@/Users/smintz/git/platform-engineering/.augment/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain .augment/rules/ mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks .augment/rules/ requires"
...
@/Users/smintz/git/platform-engineering/.augment/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a .augment/rules/ convention, or an active capability constraint. If
