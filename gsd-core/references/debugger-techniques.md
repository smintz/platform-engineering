...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering
                  → checks /Users/smintz/git/platform-engineering/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/gsd-core/hooks/
