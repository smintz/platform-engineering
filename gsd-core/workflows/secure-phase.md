...
```
Agent(
  prompt="Read /Users/smintz/git/platform-engineering/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/git/platform-engineering/gsd-core/templates/SECURITY.md`
