...
in `execute-phase.md` step 3 (on Cline it is literally `isolation="worktree"`).
...
<mcp_tools>
If .clinerules or project instructions reference MCP tools, prefer those tools
...
WT_PATH="${ORCH_ROOT}/.cline/worktrees/${AGENT_ID}"
