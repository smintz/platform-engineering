...
ones). Reference: @/Users/smintz/git/platform-engineering/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/smintz/git/platform-engineering.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/smintz/git/platform-engineering/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/smintz/git/platform-engineering/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/smintz/git/platform-engineering/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/smintz/git/platform-engineering/gsd-core/templates/spec.md.
