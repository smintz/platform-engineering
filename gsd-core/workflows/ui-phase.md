...
```markdown
Read /Users/smintz/git/platform-engineering/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/smintz/git/platform-engineering/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/smintz/git/platform-engineering/agents/gsd-ui-checker.md for instructions.
...
you used. Re-check the user's locked answers, capability guidance (.clinerules, project skills) and
...
@/Users/smintz/git/platform-engineering/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/smintz/git/platform-engineering.
...
UI_PROBE_JS=$(for _c in \
  ...
  "$_GSD_RT/.cline/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
