...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.opencode/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.opencode/skills`).
...
`/Users/smintz/git/platform-engineering/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/smintz/git/platform-engineering/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.opencode/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.opencode/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.opencode/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
