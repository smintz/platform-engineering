...
<required_reading>
Read `/Users/smintz/git/platform-engineering/.opencode/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
