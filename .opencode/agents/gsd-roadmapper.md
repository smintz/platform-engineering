...
Reference full template: `/Users/smintz/git/platform-engineering/.opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/smintz/git/platform-engineering/.opencode/gsd-core/templates/state.md`.
