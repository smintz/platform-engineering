...
```markdown
Read /Users/smintz/git/platform-engineering/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/smintz/git/platform-engineering/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/smintz/git/platform-engineering/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/Users/smintz/git/platform-engineering/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/smintz/git/platform-engineering/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/smintz/git/platform-engineering/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
