...
- Usage: Reference from command with `@/Users/smintz/git/platform-engineering/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/smintz/git/platform-engineering/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/smintz/git/platform-engineering/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
