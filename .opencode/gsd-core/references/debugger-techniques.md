...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.opencode
                  → checks /Users/smintz/git/platform-engineering/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.opencode/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.opencode/gsd-core/hooks/
