...
@/Users/smintz/git/platform-engineering/.qwen/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain QWEN.md mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks QWEN.md requires"
...
@/Users/smintz/git/platform-engineering/.qwen/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a QWEN.md convention, or an active capability constraint. If
