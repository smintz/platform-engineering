...
Use template from `/Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / QWEN.md rule / spec constraint} | {one line} |
