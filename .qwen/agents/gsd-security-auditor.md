...
**Verification depth scales with `asvs_level`** (see @/Users/smintz/git/platform-engineering/.qwen/gsd-core/references/security-asvs-levels.md for full definitions):
