...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.qwen
                  → checks /Users/smintz/git/platform-engineering/.qwen/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.qwen/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.qwen/gsd-core/hooks/
