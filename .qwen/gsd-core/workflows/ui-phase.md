...
```markdown
Read /Users/smintz/git/platform-engineering/.qwen/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/smintz/git/platform-engineering/.qwen/agents/gsd-ui-checker.md for instructions.
...
you used. Re-check the user's locked answers, capability guidance (QWEN.md, project skills) and
...
@/Users/smintz/git/platform-engineering/.qwen/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/smintz/git/platform-engineering/.qwen.
...
UI_PROBE_JS=$(for _c in \
  ...
  "$_GSD_RT/.qwen/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/.qwen/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/.qwen/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
