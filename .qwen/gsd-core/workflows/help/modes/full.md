...
**GSD Core** (Git. Ship. Done.) creates hierarchical project plans optimized for solo agentic development with Qwen Code.
...
- Saves timestamped note to `.planning/notes/` (or `/Users/smintz/git/platform-engineering/.qwen/notes/` globally)
