...
in `execute-phase.md` step 3 (on Qwen Code it is literally `isolation="worktree"`).
...
<mcp_tools>
If QWEN.md or project instructions reference MCP tools, prefer those tools
...
WT_PATH="${ORCH_ROOT}/.qwen/worktrees/${AGENT_ID}"
