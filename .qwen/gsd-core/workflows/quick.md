...
- ./QWEN.md or ./.qwen/QWEN.md (if exists — follow project-specific guidelines)
...
execute-phase's #683/#1369 guard). Qwen Code's `isolation="worktree"` forks new worktrees from
...
- ${STATE_PATH} (Project state)
- ./QWEN.md or ./.qwen/QWEN.md (Project instructions, if exists)
