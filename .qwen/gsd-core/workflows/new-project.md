...
Use template: /Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.qwen/gsd-core/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (runtime-derived via the shared `getProjectInstructionFile` policy: `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.qwen/QWEN.md` for claude)
