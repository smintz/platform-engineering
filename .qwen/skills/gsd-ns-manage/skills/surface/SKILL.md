...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.qwen/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.qwen/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.qwen/skills/gsd-*/`.
...
(`/Users/smintz/git/platform-engineering/.qwen`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.qwen/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/smintz/git/platform-engineering/.qwen` as `configDir`. The skill dirs themselves live at
`/Users/smintz/git/platform-engineering/.qwen/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Qwen Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/smintz/git/platform-engineering/.qwen}"
SCOPE="global"
...
(i.e. `/Users/smintz/git/platform-engineering/.qwen/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.qwen/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.qwen/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.qwen/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.qwen/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.qwen/gsd-core/bin/lib/clusters.cjs`
</execution_context>
