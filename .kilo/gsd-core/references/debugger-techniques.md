...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.kilo
                  → checks /Users/smintz/git/platform-engineering/.kilo/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.kilo/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.kilo/gsd-core/hooks/
