...
Read and follow `/Users/smintz/git/platform-engineering/.kilo/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
