...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @/Users/smintz/git/platform-engineering/.kilo/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
