...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.kilo/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.kilo/skills`).
...
`/Users/smintz/git/platform-engineering/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/smintz/git/platform-engineering/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.kilo/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.kilo/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.kilo/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.kilo/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.kilo/gsd-core/bin/lib/clusters.cjs`
</execution_context>
