...
<!-- For checkpoint task examples and patterns, see @/Users/smintz/git/platform-engineering/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/smintz/git/platform-engineering/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/smintz/git/platform-engineering/.claude/gsd-core/templates/user-setup.md` for full schema and examples
