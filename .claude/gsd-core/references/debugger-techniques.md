...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.claude
                  → checks /Users/smintz/git/platform-engineering/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.claude/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.claude/gsd-core/hooks/
