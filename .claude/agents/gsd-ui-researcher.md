...
Use template from `/Users/smintz/git/platform-engineering/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/smintz/git/platform-engineering/.claude/gsd-core/templates/UI-SPEC.md`
