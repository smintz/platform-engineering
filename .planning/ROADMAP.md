...
- [x] 01-01-PLAN.md — Drift check tracer: a hand-written workflow compiles the source and asserts the committed output matches; orphan root output trees deleted (FOUND-01)
...
- [x] 01-04-PLAN.md — `make gates`: the two compile gates gain a committed defence that asserts on each gate's own message, invoked from `make test` and therefore covered by drift.yaml (FOUND-04, FOUND-05)
