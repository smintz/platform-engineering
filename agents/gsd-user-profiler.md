...
<reference>
@/Users/smintz/git/platform-engineering/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/smintz/git/platform-engineering/gsd-core/references/user-profiling.md` to load:
