...
@/Users/smintz/git/platform-engineering/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain .clinerules mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks .clinerules requires"
...
@/Users/smintz/git/platform-engineering/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a .clinerules convention, or an active capability constraint. If
