...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # #2647: create the worktree INSIDE the repo under the same `.cline/worktrees/`
  ...
  # `.gitignore` rule for `.cline/` (`.gitignore:12`). Uniqueness across
  ...
  wt="$main_repo/.cline/worktrees/rf-${padded_phase}-$$-$(date +%s)"
  mkdir -p "$wt"
