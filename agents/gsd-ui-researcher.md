...
Use template from `/Users/smintz/git/platform-engineering/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/smintz/git/platform-engineering/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / .clinerules rule / spec constraint} | {one line} |
