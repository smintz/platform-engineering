...
- .windsurf/rules or ./.windsurf/.windsurf/rules (if exists — follow project-specific guidelines)
...
execute-phase's #683/#1369 guard). Windsurf's `isolation="worktree"` forks new worktrees from
...
- ${STATE_PATH} (Project state)
- .windsurf/rules or ./.windsurf/.windsurf/rules (Project instructions, if exists)
