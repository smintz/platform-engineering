...
in `execute-phase.md` step 3 (on Windsurf it is literally `isolation="worktree"`).
...
<mcp_tools>
If .windsurf/rules or project instructions reference MCP tools, prefer those tools
...
WT_PATH="${ORCH_ROOT}/.windsurf/worktrees/${AGENT_ID}"
