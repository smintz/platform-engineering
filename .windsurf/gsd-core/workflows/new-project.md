...
Use template: /Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (runtime-derived via the shared `getProjectInstructionFile` policy: `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.windsurf/.windsurf/rules` for claude)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (runtime-derived via the shared `getProjectInstructionFile` policy — `AGENTS.md` for codex/opencode/kilo/kimi, `.github/copilot-instructions.md` for copilot, `GEMINI.md` for gemini/antigravity, `.windsurf/.windsurf/rules` for claude; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
