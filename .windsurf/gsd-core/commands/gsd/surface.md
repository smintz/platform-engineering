...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.windsurf/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.windsurf/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.windsurf/skills/gsd-*/`.
...
(`/Users/smintz/git/platform-engineering/.windsurf`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.windsurf/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/smintz/git/platform-engineering/.windsurf` as `configDir`. The skill dirs themselves live at
`/Users/smintz/git/platform-engineering/.windsurf/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Windsurf — global install
RUNTIME_CONFIG_DIR="${WINDSURF_CONFIG_DIR:-/Users/smintz/git/platform-engineering/.windsurf}"
SCOPE="global"
...
(i.e. `/Users/smintz/git/platform-engineering/.windsurf/.gsd-surface.json`).

All paths can be overridden by reading the `WINDSURF_CONFIG_DIR` env var if set.
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.windsurf/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.windsurf/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.windsurf/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.windsurf/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.windsurf/gsd-core/bin/lib/clusters.cjs`
</execution_context>
