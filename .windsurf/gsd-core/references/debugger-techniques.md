...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.windsurf
                  → checks /Users/smintz/git/platform-engineering/.windsurf/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.windsurf/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.windsurf/gsd-core/hooks/
