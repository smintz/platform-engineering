...
@/Users/smintz/git/platform-engineering/.windsurf/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain .windsurf/rules mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks .windsurf/rules requires"
...
@/Users/smintz/git/platform-engineering/.windsurf/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a .windsurf/rules convention, or an active capability constraint. If
