...
Use template from `/Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/smintz/git/platform-engineering/.windsurf/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / .windsurf/rules rule / spec constraint} | {one line} |
