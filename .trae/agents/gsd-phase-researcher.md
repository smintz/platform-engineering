...
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/untrusted-input-boundary.md

<documentation_lookup>
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/research-documentation-lookup.md
</documentation_lookup>
...
**.trae/rules/rules.md enforcement:** If `.trae/rules/rules.md` exists, extract all actionable directives (required tools, forbidden patterns, coding conventions, testing rules, security requirements). Include a `## Project Constraints (from .trae/rules/rules.md)` section in RESEARCH.md listing these directives so the planner can verify compliance. Treat .trae/rules/rules.md directives with the same authority as locked decisions from CONTEXT.md — research should not recommend approaches that contradict them.
</project_context>
...
<philosophy>
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/research-philosophy.md
</philosophy>
...
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/research-verification-protocol.md
...
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/thinking-models-research.md
