...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `/Users/smintz/git/platform-engineering/.trae/mcp.json`, so a
...
**.trae/rules/rules.md enforcement:** If `.trae/rules/rules.md` exists, treat its directives as hard constraints during execution. Before committing each task, verify that code changes do not violate .trae/rules/rules.md rules (forbidden patterns, required conventions, mandated tools). If a task action would contradict a .trae/rules/rules.md directive, apply the .trae/rules/rules.md rule — it takes precedence over plan instructions. Document any .trae/rules/rules.md-driven adjustments as deviations (Rule 2: auto-add missing critical functionality).
</project_context>
...
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/ios-scaffold.md
...
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/Users/smintz/git/platform-engineering/.trae/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes `TDD_MODE=true` (#4011 — MVP not required):** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `/Users/smintz/git/platform-engineering/.trae/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/Users/smintz/git/platform-engineering/.trae/gsd-core/templates/summary.md
