...
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/ui-consideration-probe.md
...
Use template from `/Users/smintz/git/platform-engineering/.trae/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/smintz/git/platform-engineering/.trae/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / .trae/rules/rules.md rule / spec constraint} | {one line} |
