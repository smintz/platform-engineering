...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.trae
                  → checks /Users/smintz/git/platform-engineering/.trae/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.trae/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.trae/gsd-core/hooks/
