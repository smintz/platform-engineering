...
- .trae/rules/rules.md or ./.trae/rules/rules.md (if exists — follow project-specific guidelines)
...
execute-phase's #683/#1369 guard). Trae's `isolation="worktree"` forks new worktrees from
...
- ${STATE_PATH} (Project state)
- .trae/rules/rules.md or ./.trae/rules/rules.md (Project instructions, if exists)
