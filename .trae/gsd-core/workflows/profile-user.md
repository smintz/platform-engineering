...
Key references:
- @/Users/smintz/git/platform-engineering/.trae/gsd-core/references/ui-brand.md (display patterns)
- @/Users/smintz/git/platform-engineering/.trae/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/smintz/git/platform-engineering/.trae/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/smintz/git/platform-engineering/.trae/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/smintz/git/platform-engineering/.trae/gsd-core/USER-PROFILE.md" "/Users/smintz/git/platform-engineering/.trae/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/smintz/git/platform-engineering/.trae/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/smintz/git/platform-engineering/.trae/gsd-core/references/user-profiling.md`
...
Reference: @/Users/smintz/git/platform-engineering/.trae/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/smintz/git/platform-engineering/.trae/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - ".trae/rules/rules.md profile section" -- "Add profile to this project's .trae/rules/rules.md"
  - "Global .trae/rules/rules.md" -- "Add profile to /Users/smintz/git/platform-engineering/.trae/rules/rules.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/smintz/git/platform-engineering/.trae/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/smintz/git/platform-engineering/.trae/skills/gsd-dev-preferences/SKILL.md"

**For .trae/rules/rules.md profile section (if selected):**

```bash
gsd_run query generate-claude-profile --analysis "$ANALYSIS_PATH" --json
```

Display: "✓ Added profile section to .trae/rules/rules.md"

**For Global .trae/rules/rules.md (if selected):**

```bash
gsd_run query generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json
```

Display: "✓ Added profile section to /Users/smintz/git/platform-engineering/.trae/rules/rules.md"
...
```bash
BACKUP_PATH="/Users/smintz/git/platform-engineering/.trae/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/smintz/git/platform-engineering/.trae/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/smintz/git/platform-engineering/.trae/skills/gsd-dev-preferences/SKILL.md
  ✓ .trae/rules/rules.md section       <resolved claude_md_path, default ./.trae/rules/rules.md>
  ✓ Global .trae/rules/rules.md        /Users/smintz/git/platform-engineering/.trae/rules/rules.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.trae/rules/rules.md` but may be overridden by config or `--output`.)
