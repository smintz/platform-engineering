...
**GSD Core** (Git. Ship. Done.) creates hierarchical project plans optimized for solo agentic development with Trae.
...
- Adds auto-load routing line to project .trae/rules/rules.md
...
- Saves timestamped note to `.planning/notes/` (or `/Users/smintz/git/platform-engineering/.trae/notes/` globally)
