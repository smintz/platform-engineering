...
```markdown
Read /Users/smintz/git/platform-engineering/.trae/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/smintz/git/platform-engineering/.trae/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/smintz/git/platform-engineering/.trae/agents/gsd-ui-checker.md for instructions.
...
you used. Re-check the user's locked answers, capability guidance (.trae/rules/rules.md, project skills) and
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/smintz/git/platform-engineering/.trae.
...
UI_PROBE_JS=$(for _c in \
  ...
  "$_GSD_RT/.trae/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/.trae/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/smintz/git/platform-engineering/.trae/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
