...
in `execute-phase.md` step 3 (on Trae it is literally `isolation="worktree"`).
...
<mcp_tools>
If .trae/rules/rules.md or project instructions reference MCP tools, prefer those tools
...
WT_PATH="${ORCH_ROOT}/.trae/worktrees/${AGENT_ID}"
