...
## Update Project .trae/rules/rules.md

Add an auto-load routing line to the project's .trae/rules/rules.md (create the file if it doesn't exist):
...
**.trae/rules/rules.md:** routing line added
...
- [ ] Project .trae/rules/rules.md has auto-load routing line
- [ ] Summary presented
