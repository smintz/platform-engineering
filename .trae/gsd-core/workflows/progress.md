...
> for project name, milestone, current phase, and next-step routing. .trae/rules/rules.md ## Project
> blocks are a secondary config aid that may be significantly stale — do NOT use the
> .trae/rules/rules.md project description as a source for any progress report field.
