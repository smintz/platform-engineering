...
<required_reading>
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/user-story-template.md
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/spidr-splitting.md
@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/smintz/git/platform-engineering/.trae/gsd-core/references/spidr-splitting.md`. Briefly:
