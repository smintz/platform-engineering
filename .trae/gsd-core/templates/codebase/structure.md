...
- `.trae/rules/rules.md` - Instructions for Trae when working in this repo
...
- Usage: Reference from command with `@/Users/smintz/git/platform-engineering/.trae/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/smintz/git/platform-engineering/.trae/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/smintz/git/platform-engineering/.trae/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
