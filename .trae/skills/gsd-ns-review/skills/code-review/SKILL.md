...
<execution_context>
@/Users/smintz/git/platform-engineering/.trae/gsd-core/workflows/code-review.md
</execution_context>
...
Context files (.trae/rules/rules.md, SUMMARY.md, phase state) are resolved inside the workflow via `gsd-tools query init.phase-op` and delegated to agent via `<required_reading>` blocks.
</context>
