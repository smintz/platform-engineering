...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/git/platform-engineering/.trae/.gsd-surface.json`
(sibling to `/Users/smintz/git/platform-engineering/.trae/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/git/platform-engineering/.trae/skills/gsd-*/`.
...
(`~/.trae`), NOT the skills sub-directory (`/Users/smintz/git/platform-engineering/.trae/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `~/.trae` as `configDir`. The skill dirs themselves live at
`/Users/smintz/git/platform-engineering/.trae/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Trae — global install
RUNTIME_CONFIG_DIR="${TRAE_CONFIG_DIR:-$HOME/.trae}"
SCOPE="global"
...
(i.e. `/Users/smintz/git/platform-engineering/.trae/.gsd-surface.json`).

All paths can be overridden by reading the `TRAE_CONFIG_DIR` env var if set.
...
<execution_context>
Surface state file: `/Users/smintz/git/platform-engineering/.trae/.gsd-surface.json`
Install profile marker: `/Users/smintz/git/platform-engineering/.trae/.gsd-profile`
Skill dirs: `/Users/smintz/git/platform-engineering/.trae/skills/gsd-*/`
Engine module: `/Users/smintz/git/platform-engineering/.trae/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/git/platform-engineering/.trae/gsd-core/bin/lib/clusters.cjs`
</execution_context>
