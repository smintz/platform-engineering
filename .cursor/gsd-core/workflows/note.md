...
- **Global scope**: `/Users/smintz/git/platform-engineering/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/smintz/git/platform-engineering/.cursor/notes/`)
...
2. Glob `/Users/smintz/git/platform-engineering/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/smintz/git/platform-engineering/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/smintz/git/platform-engineering/.cursor/notes/` — works in any directory
