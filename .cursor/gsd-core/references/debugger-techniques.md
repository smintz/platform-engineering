...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.cursor
                  → checks /Users/smintz/git/platform-engineering/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.cursor/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.cursor/gsd-core/hooks/
