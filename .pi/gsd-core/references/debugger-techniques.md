...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.pi
                  → checks /Users/smintz/git/platform-engineering/.pi/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.pi/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.pi/gsd-core/hooks/
