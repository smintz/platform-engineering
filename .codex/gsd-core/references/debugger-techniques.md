...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.codex
                  → checks /Users/smintz/git/platform-engineering/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.codex/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.codex/gsd-core/hooks/
