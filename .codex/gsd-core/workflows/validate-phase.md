...
```
Agent(
  prompt="Read /Users/smintz/git/platform-engineering/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/git/platform-engineering/.codex/gsd-core/templates/VALIDATION.md`
