...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/git/platform-engineering/.codebuddy
                  → checks /Users/smintz/git/platform-engineering/.codebuddy/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/git/platform-engineering/.codebuddy/gsd-core
                  → writes to /Users/smintz/git/platform-engineering/.codebuddy/gsd-core/hooks/
