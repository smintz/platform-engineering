...
@/Users/smintz/git/platform-engineering/.codebuddy/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain CODEBUDDY.md mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks CODEBUDDY.md requires"
...
@/Users/smintz/git/platform-engineering/.codebuddy/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a CODEBUDDY.md convention, or an active capability constraint. If
